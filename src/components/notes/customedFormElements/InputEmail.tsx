...
function InputEmail(props:any, ref:any){
  ...
  return <div className={generalcls.field}>
    <label htmlFor={emailId} className={classes.label}>Email address</label>
    <input type='email' id={emailId} ref={ref} className={classes.email} required placeholder='ex:name@yahoo.com' title=''></input>
  </div>
}
