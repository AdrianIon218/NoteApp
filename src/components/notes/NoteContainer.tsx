...
const compsToShow = [{noteState:ButtonSelected.viewNotes, component:<ViewNote />},
...
export default function NoteContainer({currentStatus}:IProps){
  const compSelected = compsToShow.filter((item)=>item.noteState === currentStatus)[0]
  
  return(<section className={classes.noteContainer}>
