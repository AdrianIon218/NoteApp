...
function ContactForm(){
  ...
  function submit(event:React.FormEvent<HTMLFormElement>){
    ...
    if(!showMessage){
      ...
      axios.post('https://noteapp-9b1f0-default-rtdb.europe-west1.firebasedatabase.app/messages.json',data).then((res)=>{
        setShowMessage(true);
  ...
  return (<>
  {showMessage && (<TemporalNotification hideMessage={hideMessage} durationSeconds={2.65}>Message sent !</TemporalNotification>)}
